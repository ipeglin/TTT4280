...
/* RPi PIN ASSIGNMENTS */
#define MISO1 23    // ADC 1 MISO (BCM 4 aka GPIO 4).
#define MISO2 24    //     2
#define MISO3 25    //     3
#define MISO4 26    //     4
#define MISO5 27    //     5
...
#define SPI_SS 4   // GPIO for slave select (BCM 8 aka GPIO 8 aka SPI_CE0).
#define CLK 6      // GPIO for SPI clock (BCM 11 aka GPIO 11 aka SPI_CLK).
